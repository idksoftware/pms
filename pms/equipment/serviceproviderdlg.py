...
#from appointmentappointmentbookctrl import AppointmentBookCtrl
#from appointmentdetailsctrl import AppointmentDetailsCtrl
 



class ServiceProviderDialog(wx.Dialog):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        wx.Dialog.__init__(self, None, -1, "Service Provider Details", size=(1000, 600))
        '''
        Constructor
        '''
        self.panel = ServiceProviderPanel(self)
...
class ServiceProviderPanel(wx.Panel):
    def __init__(self, parent):
        super(ServiceProviderPanel, self).__init__(parent, style=wx.LB_BOTTOM, size=(1000, 600))
...
class TestApp(wx.App):
    def OnInit(self):
        ...
        print "Opening ServiceProviderDialog"
        serviceProviderDialog.ShowModal()
        print "Closing ServiceProviderDialog"
