...
def cpdtable_suite():
    suite = unittest.TestSuite()
    suite.addTest(AccessTest("test80"))
    suite.addTest(AccessTest("test91"))
    suite.addTest(AccessTest("test92"))
    suite.addTest(AccessTest("test93"))
    suite.addTest(AccessTest("test94"))
...
def main():
    ...
    try:
        ...
        '''
        print "CPD Tests"
        unittest.TextTestRunner(verbosity=1).run(cpdtable_suite())
